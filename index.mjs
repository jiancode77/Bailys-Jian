...
const sock=makeWASocket({version,auth:state,printQRInTerminal:false,generateHighQualityLinkPreview:true});
sock.ev.on("creds.update",saveCreds);
sock.ev.on("connection.update",u=>{if(u.qr)const now=new Date().toLocaleTimeString();
